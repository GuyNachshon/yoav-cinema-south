        ...
        fields: [
          { type: "string", name: "name", label: "Document name (for admin)", description: "Display name in Tina sidebar", ui: { component: null } },
          {
            ...
            fields: [
              ...
              { type: "string", name: "title", label: "Title" },
              { type: "number", name: "order", label: "Order" },
              { type: "number", name: "speed", label: "Speed (seconds per loop)", description: "Lower = faster. Default 40." },
              { type: "number", name: "acceleration", label: "Acceleration (seconds to ramp on hover)" },
              { type: "string", name: "direction", label: "Direction", options: ["left", "right"] },
              { type: "number", name: "itemGap", label: "Gap between items (px)" },
              { type: "number", name: "repeat", label: "Repeat count" },
            ],
          },
        ],
